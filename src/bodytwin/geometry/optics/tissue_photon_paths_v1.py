"""Observe certified transport paths and exits without changing photon propagation.
...
if __name__=='__main__':
    ...
    raise SystemExit(subprocess.call([sys.executable,str(root/'probes/optics/photon_detector_probe.py')]))
