"""Replay two pipeline gate contracts with explicit output filenames."""
import argparse
import ast
import hashlib
import json
...
CELLS={
    'cardiovascular/cardiac_output_geometric.py': ('8c55ca5dabe0c9a85c36212071687c266188a5ee1f8f2e733ab9586eb7db372b',16,'overall_pass','gates','cardiac_output_geometric_results.json'),
    'endocrine/glucose_insulin_minimal_model.py': ('ad7169a41c6c784417648c46a142193b8a582369f15cf580961c9fc192f2d6c9',9,'overall_pass','gates','glucose_insulin_minimal_model.json')}
