"""Replay two pinned all-gates contracts with explicit overall-field names."""
import argparse
import ast
import hashlib
import json
...
CELLS={
    'cardiovascular/capillary_starling.py': ('c2307a8d30932d2da83cbb607a3e670f6513445c70027694d7ff2a8fdab989ea',14,'overall_pass','gates'),
    'haematology/iron_hepcidin_dynamic_4state.py': ('404179f718a47a8f9a14c83ff47ab9e0b0264b61b5b6f0ac792acc496ac8c2b7',7,'required_gates_overall_pass','GATES')}
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='required-cells-') as directory:
        for leg in (0,1):
            ...
            for name,(pin,count,overall,variable) in CELLS.items():
