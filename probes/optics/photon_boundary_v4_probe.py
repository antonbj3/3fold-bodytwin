"""Unchanged physical boundary/slab gates for the separate cumulative-weight variant."""
import hashlib
import json
...
from bodytwin.geometry.optics.tissue_photon_mc_v4 import simulate,PACKET
...
def main():
    ...
    (ROOT/'reports/photon_boundary_v4.json').write_text(json.dumps(report,indent=2)+'\n')
