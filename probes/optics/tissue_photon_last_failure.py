"""Observe the final failing packet of the frozen parametric photon variant.
...
def simulate(vertices,faces,properties,face_front,face_back,*,source,direction,initial_region,
    ...
    terminal=wp.zeros((photons,12),dtype=wp.int64,device=device);counters=wp.zeros(3,dtype=wp.int64,device=device)
