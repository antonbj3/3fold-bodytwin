...
def main():
    paths=np.load(ROOT/'reports/photon_detector_paths_l4.npz')['paths_0'];legs=[measure(paths),measure(paths)]
    ...
    (ROOT/'reports/nirs_uncertainty_mechanism.json').write_text(json.dumps(report,indent=2)+'\n')
