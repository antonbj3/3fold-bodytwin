...
from bodytwin.geometry.optics.tissue_photon_mc_v2 import simulate,PACKET
...
def main():
    ...
    (ROOT/'reports/photon_cube_v2.json').write_text(json.dumps(report,indent=2)+'\n')
    np.savez_compressed(ROOT/'reports/photon_cube_v2_fields.npz',first=outputs[0]['absorption'],second=outputs[1]['absorption'])
