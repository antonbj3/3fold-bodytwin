...
def main():
    ...
    (ROOT/'reports/photon_cube_v3.json').write_text(json.dumps(report,indent=2)+'\n')
    np.savez_compressed(ROOT/'reports/photon_cube_v3_fields.npz',first=outputs[0]['absorption'],second=outputs[1]['absorption'])
